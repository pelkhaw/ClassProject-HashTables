 ...
 *   -r run the retrieve driver and specify the type of initial table keys 
 *      (rand|seq|fold|worst)
...
static int Seed = 113654361;
static int test=0;
static int del=FALSE;
...
void TestDriver1(void);
void TestDriver2(void);
...
void RehashDriver(int test_M)
{
    ...
    *ip = 76;
    ...
    // If linear or 7quad, double the size
...
int build_seq(table_t *T, int table_size, int num_addr)
{
    ...
    for (i = starting; i < starting + num_addr; i++) {
        ...
        *ip = i;
        code = table_insert(T, key, ip);
        if (code != 0) {
            printf("build of  table failed code (%d) index (%d) key (%u)\n",
                    code, i - starting, key);
            exit(3);
        }
        probes += table_stats(T);
    ...
    while ((c = getopt(argc, argv, "m:p:a:h:i:t:s:erdbv")) != -1)
        switch(c) {
            ...
            default:
                      ...
                      printf("  -p(1|2) Test driver Studant made\n");  
...
void TestDriver1()
{
    ...
    H = table_construct(8, DOUBLE);
    table_delete(H,8);
    table_retrieve(H,8);
    
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,10,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,18,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,26,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;  
    table_insert(H,34,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,42,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,50,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,58,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    free(ip);
    table_insert(H,66,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    free(ip);
    table_insert(H,74,ip);
    ipd=table_delete(H,18);     
    free(ipd);
    ipd=table_delete(H,26);
    free(ipd);
    table_debug_print(H);
    table_destruct(H);
...
void TestDriver2()
{
    ...
    *ip = 10;
    ...
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,99,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,100,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,7777777,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,74,ip);
    table_debug_print(H);
...
void DeletionDriver()
{
    ...
    *ip = 10;
    ...
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,12,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,11,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;  
    table_insert(H,19,ip);
    table_debug_print(H);    
    ipd=table_delete(H,5);     
    free(ipd);
    ipd=table_delete(H,8);
    ipd=table_delete(H,12);     
    free(ipd);
    table_debug_print(H);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    ...
    *ip = 10;  
    table_insert(H,12,ip);
    table_debug_print(H);
    ipd=table_delete(H,7);     
    free(ipd);
    ipd=table_delete(H,8);
    free(ipd);
    ipd=table_delete(H,9);     
    free(ipd);
    ipd=table_delete(H,10);     
    free(ipd);
    table_debug_print(H);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;
    table_insert(H,13,ip);
    ip = (int *) malloc(sizeof(int));
    *ip = 10;  
    table_insert(H,14,ip);
    
    ip=table_retrieve(H,16);
    if(ip==NULL)
                printf("16 not retrieved\n");
    else
                printf("16 retrieved\n");
    table_debug_print(H);
    table_destruct(H);

        printf("\n----- End Deletion driver Hash 2-----\n");
        printf("\n    ----- End Deletion driver-----\n");
}
